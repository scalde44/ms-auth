...
import co.com.pragma.r2dbc.user.repository.PostgreSQLUserReactiveRepository;
...
class PostgreSQLUserReactiveRepositoryAdapterTest {
    ...
    @Mock
    PostgreSQLUserReactiveRepository repository;
